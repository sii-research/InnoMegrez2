...
class FusedMoE(CustomOp):
    ...
    def forward(self, hidden_states: torch.Tensor,
        ...
        if current_platform.is_tpu():
            return self.forward_impl(hidden_states, router_logits, e_score_correction_bias)
        else:
            return torch.ops.vllm.moe_forward(
                hidden_states, router_logits,
                self.layer_name, e_score_correction_bias)[..., :og_hidden_states]
    ...
    def forward_impl_chunked(self, full_hidden_states: torch.Tensor,
        ...
        def process_chunk(chunk_start, chunk_end, skip_result_store=False, e_score_correction_bias=None):
...
def moe_forward(hidden_states: torch.Tensor, router_logits: torch.Tensor,
                layer_name: str, e_score_correction_bias: Optional[torch.Tensor] = None,) -> torch.Tensor:
